...
# # Predicting booking_bool in Cluster1

# ### Notebook automatically generated from your model

# Model Logistic Regression, trained on 2017-08-23 11:52:35.

# #### Generated on 2017-08-30 21:17:48.568456

# prediction
# This notebook will reproduce the steps for a BINARY_CLASSIFICATION on  Cluster1.
...
ml_dataset_handle = dataiku.Dataset('Cluster1')
...
ml_dataset = ml_dataset[[u'srch_saturday_night_bool', u'prop_location_score1', u'srch_booking_window', u'booking_bool', u'srch_length_of_stay', u'price_usd', u'position', u'srch_adults_count']]
...
categorical_features = [u'srch_saturday_night_bool']
numerical_features = [u'prop_location_score1', u'srch_booking_window', u'srch_length_of_stay', u'price_usd', u'position', u'srch_adults_count']
text_features = []
...
impute_when_missing = [{'impute_with': u'MODE', 'feature': u'srch_saturday_night_bool'}, {'impute_with': u'MEAN', 'feature': u'prop_location_score1'}, {'impute_with': u'MEAN', 'feature': u'srch_booking_window'}, {'impute_with': u'MEAN', 'feature': u'srch_length_of_stay'}, {'impute_with': u'MEAN', 'feature': u'price_usd'}, {'impute_with': u'MEAN', 'feature': u'position'}, {'impute_with': u'MEAN', 'feature': u'srch_adults_count'}]
...
categorical_to_dummy_encode = [u'srch_saturday_night_bool']
...
rescale_features = {u'srch_booking_window': u'AVGSTD', u'price_usd': u'AVGSTD', u'prop_location_score1': u'AVGSTD', u'position': u'AVGSTD', u'srch_adults_count': u'AVGSTD', u'srch_length_of_stay': u'AVGSTD'}
